...
void changedCallback(int, int nInserted, int nDeleted, int, const char *,
                     void *data) {
...
void exitCallback(Fl_Widget *widget, void *data) { exit(0); }
...
void undoCallback(void) { textbuffer->undo(); }
